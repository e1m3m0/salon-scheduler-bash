...
INSERT INTO public.appointments VALUES (7, 31, 4, '8AM');
...
INSERT INTO public.customers VALUES (31, 'Guillermo', '000-000-0000');
...
--
-- Name: appointments appointment_ser_fgnky; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT appointment_ser_fgnky FOREIGN KEY (service_id) REFERENCES public.services(service_id);
